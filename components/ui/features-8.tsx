...
const cardClass =
  "border-white/[0.08] bg-white/[0.02] shadow-none backdrop-blur-sm transition-colors hover:border-white/[0.14] hover:bg-white/[0.04]";

export function FeaturesEight() {
  return (
    <section id="features" className="relative scroll-mt-24 py-16 md:py-32">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_50%_at_80%_20%,rgba(99,102,241,0.06),transparent_55%)]" />
      ...
      <div className="relative mx-auto max-w-3xl px-6 lg:max-w-5xl">
        <div className="mb-14 flex flex-col gap-6 lg:mb-16 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-5 text-3xl font-semibold leading-[1.1] tracking-tight sm:text-4xl lg:text-5xl">
              Chaque module a sa place.{" "}
              <span className="text-emerald-400">Rien en double.</span>
            </h2>
          </div>
          <p className="max-w-md text-base leading-relaxed text-muted-foreground sm:text-lg lg:text-right">
            Cinq sections dans la sidebar — suivi, analyse, news, fiscalité et
            live. Un seul outil, zéro dispersion.
          </p>
        </div>

        <div className="relative">
          <div className="relative z-10 grid grid-cols-6 gap-3">
            <Card className={`relative col-span-full flex overflow-hidden lg:col-span-2 ${cardClass}`}>
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center">
                  ...
                  <span className="mx-auto block w-fit text-5xl font-semibold text-emerald-400">
                    5
                  </span>
                </div>
                <h3 className="mt-6 text-center text-xl font-semibold sm:text-2xl">
                  Modules dédiés
                </h3>
                <p className="mt-2 text-center text-sm text-muted-foreground">
                  Dashboard, portefeuille, news, fiscalité et live studio
                </p>
              </CardContent>
            </Card>

            <Card className={`relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 ${cardClass}`}>
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                  ...
                  >
                    <path
                      ...
                      fill="currentColor"
                    />
                    <g clipPath="url(#clip0_features8_live)">
                      <path
                        d="M44.0209 55.3542C43.1945 54.7639 42.6916 54.0272 42.5121 53.1442C42.3327 52.2611 42.5995 51.345 43.3125 50.3958C50.632 40.3611 59.812 32.5694 70.8525 27.0208C81.8931 21.4722 93.668 18.6979 106.177 18.6979C118.691 18.6979 130.497 21.3849 141.594 26.7587C152.691 32.1326 161.958 39.8936 169.396 50.0417C170.222 51.1042 170.489 52.0486 170.196 52.875C169.904 53.7014 169.401 54.4097 168.688 55C167.979 55.5903 167.153 55.8571 166.208 55.8004C165.264 55.7437 164.438 55.2408 163.729 54.2917C157.236 45.0833 148.885 38.0307 138.675 33.1337C128.466 28.2368 117.633 25.786 106.177 25.7812C94.7257 25.7812 83.9827 28.2321 73.948 33.1337C63.9132 38.0354 55.5903 45.0881 48.9792 54.2917C48.2709 55.3542 47.4445 55.9444 46.5 56.0625C45.5556 56.1806 44.7292 55.9444 44.0209 55.3542ZM126.188 142.656C113.91 139.587 103.875 133.476 96.0834 124.325C88.2917 115.173 84.3959 103.988 84.3959 90.7708C84.3959 84.8681 86.5209 79.9097 90.7709 75.8958C95.0209 71.8819 100.156 69.875 106.177 69.875C112.198 69.875 117.333 71.8819 121.583 75.8958C125.833 79.9097 127.958 84.8681 127.958 90.7708C127.958 94.6667 129.434 97.9439 132.385 100.602C135.337 103.261 138.819 104.588 142.833 104.583C146.847 104.583 150.271 103.256 153.104 100.602C155.938 97.9486 157.354 94.6714 157.354 90.7708C157.354 77.0764 152.337 65.566 142.302 56.2396C132.267 46.9132 120.285 42.25 106.354 42.25C92.4237 42.25 80.441 46.9132 70.4063 56.2396C60.3716 65.566 55.3542 77.0174 55.3542 90.5937C55.3542 93.4271 55.621 96.9687 56.1546 101.219C56.6882 105.469 57.9562 110.427 59.9584 116.094C60.3125 117.156 60.2842 118.101 59.8734 118.927C59.4625 119.753 58.7825 120.344 57.8334 120.698C56.8889 121.052 55.9752 121.024 55.0921 120.613C54.2091 120.202 53.5881 119.522 53.2292 118.573C51.4584 113.969 50.1905 109.395 49.4255 104.853C48.6605 100.31 48.2756 95.6158 48.2709 90.7708C48.2709 75.0694 53.9682 61.9062 65.363 51.2812C76.7577 40.6562 90.3624 35.3437 106.177 35.3437C122.115 35.3437 135.809 40.6562 147.26 51.2812C158.712 61.9062 164.438 75.0694 164.438 90.7708C164.438 96.6736 162.343 101.601 158.155 105.554C153.966 109.506 148.859 111.485 142.833 111.49C136.813 111.49 131.649 109.513 127.342 105.561C123.035 101.608 120.88 96.6783 120.875 90.7708C120.875 86.875 119.43 83.5978 116.54 80.9392C113.65 78.2805 110.196 76.9536 106.177 76.9583C102.163 76.9583 98.7089 78.2876 95.8142 80.9462C92.9195 83.6049 91.4745 86.8797 91.4792 90.7708C91.4792 102.222 94.8745 111.785 101.665 119.458C108.456 127.132 117.22 132.503 127.958 135.573C129.021 135.927 129.729 136.517 130.083 137.344C130.438 138.17 130.497 139.056 130.26 140C130.024 140.826 129.552 141.535 128.844 142.125C128.135 142.715 127.25 142.892 126.188 142.656Z"
                        fill="url(#paint0_linear_features8_live)"
                      />
                    </g>
                    <path
                    ...
                    <defs>
                      <linearGradient
                        id="paint0_linear_features8_live"
                        x1="106.385"
                        y1="1.34375"
                        x2="106"
                        y2="72"
                      ...
                      <clipPath id="clip0_features8_live">
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  <h3 className="text-lg font-medium">Cours en temps réel</h3>
                  <p className="text-sm text-muted-foreground">
                    Flux Binance SSE — BTC, ETH, SOL et toutes vos paires. Les
                    prix bougent sans recharger la page.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="pt-6">
                <div className="pt-6 lg:px-6">
                  <svg
                    ...
                    aria-hidden
                  >
                    <rect width="386" height="123" rx="10" className="fill-white/[0.02]" />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      ...
                      fill="url(#paint0_linear_features8_portfolio)"
                    />
                    <path
                      className="text-emerald-500"
                    ...
                    <defs>
                      <linearGradient
                        id="paint0_linear_features8_portfolio"
                        x1="3"
                        y1="60"
                        x2="3"
                        y2="123"
                ...
                <div className="relative z-10 mt-8 space-y-2 text-center">
                  <h3 className="text-lg font-medium">Portefeuille</h3>
                  <p className="text-sm text-muted-foreground">
                    Quantités, prix d&apos;achat, P&amp;L et répartition par actif
            ...
            <Card className={`relative col-span-full overflow-hidden lg:col-span-3 ${cardClass}`}>
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                    <Receipt className="m-auto size-5 text-emerald-400" strokeWidth={1.5} />
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium">Timeline fiscale</h3>
                    <p className="text-sm text-muted-foreground">
                      Visualisez vos événements imposables et exportez un récap
                      PDF pour votre déclaration.
                    </p>
                  </div>
                </div>
                <div className="relative -mb-6 -mr-6 mt-6 h-fit rounded-tl-xl border-l border-t border-white/[0.08] p-6 py-6 sm:ml-6">
                  ...
                  <svg
                    className="w-full sm:w-[150%] text-emerald-500/40"
                    viewBox="0 0 366 231"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                    aria-hidden
                  >
                    ...
                    <defs>
                      <linearGradient
                        id="paint0_linear_features8_fiscal"
                        x1="0.85108"
                        y1="0.947876"
                        x2="0.85108"
                        y2="230.114"
                      ...
                      >
                        ...
                        <stop offset="1" stopColor="#34d399" stopOpacity="0.01" />
                      </linearGradient>
                    </defs>
                  </svg>
                </div>
            ...
            <Card className={`relative col-span-full overflow-hidden lg:col-span-3 ${cardClass}`}>
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                    <Sparkles className="m-auto size-5 text-emerald-400" strokeWidth={1.5} />
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium">Actualités & Live Studio</h3>
                    <p className="text-sm text-muted-foreground">
                      Flux RSS crypto intégré et graphiques interactifs avec
                      sélecteur de paires — surveillez le marché en direct.
                    </p>
                  </div>
                </div>
                <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-white/[0.08] sm:-my-6 sm:-mr-6">
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      <span className="block h-fit rounded-full border border-white/10 bg-white/[0.03] px-2.5 py-1 font-mono text-xs text-muted-foreground">
                        BTC/USDT
                      </span>
                      <div className="size-7 overflow-hidden rounded-full ring-2 ring-[#060a0e]">
                        <img
                          className="size-full object-cover"
                          src="https://images.unsplash.com/photo-1639762681485-074b7f938e0e?w=100&h=100&fit=crop"
                          alt=""
                        />
                      </div>
                    </div>
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                      <div className="size-8 overflow-hidden rounded-full ring-2 ring-[#060a0e]">
                        <img
                          className="size-full object-cover"
                          src="https://images.unsplash.com/photo-1621761190629-c7960bbf5764?w=100&h=100&fit=crop"
                          alt=""
                        />
                      </div>
                      <span className="block h-fit rounded-full border border-white/10 bg-white/[0.03] px-2.5 py-1 font-mono text-xs text-muted-foreground">
                    ...
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      ...
                      <div className="size-7 overflow-hidden rounded-full ring-2 ring-[#060a0e]">
                        <img
                          className="size-full object-cover"
                          src="https://images.unsplash.com/photo-1518546305927-5a555bb7020d?w=100&h=100&fit=crop"
                          alt=""
                        />
                      </div>
                    </div>
