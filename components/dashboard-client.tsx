      ...
      <div className="relative flex min-h-screen flex-1 flex-col overflow-hidden">
        <header className="sticky top-0 z-10 border-b border-border/60 bg-background/80 backdrop-blur-xl">
          <div className="flex items-center justify-between px-6 py-4 md:px-8">
            ...
            <div className="flex items-center gap-3">
              ...
              {hasLiveData && (
                <div className="rounded-xl border border-border/60 bg-card/60 px-4 py-2 text-right">
        ...
        <main
          className={cn(
            ...
            activeSection === "live-studio" ? "px-4 py-3 md:px-6 md:py-4" : "px-6 py-6 md:px-8 md:py-8",
          )}
        >
          {activeSection === "overview" && (
            <div className="mx-auto max-w-7xl space-y-8 animate-fade-in">
              ...
              <button
                ...
                className="group flex w-full items-center justify-between rounded-2xl border border-dashed border-violet-500/40 bg-gradient-to-r from-violet-500/10 via-transparent to-emerald-500/10 p-6 text-left transition-all hover:border-violet-500/60 hover:shadow-lg hover:shadow-violet-500/10"
              >
                <div>
                ...
                <span className="rounded-xl bg-violet-500/20 px-4 py-2 text-sm font-medium text-violet-300 transition-colors group-hover:bg-violet-500/30">
                  Voir la section →
                </span>
              </button>
            </div>
